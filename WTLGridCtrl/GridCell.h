...
public:
	CGridCell();
	virtual ~CGridCell();
	virtual CGridCell* CreateObject() const        { return new CGridCell; }
	virtual LPCTSTR IsTypeOf() const               { return _T("CGridCell"); }
...
public:
    ...
    virtual CFontHandle GetFontObject() const;
...
public:
	...
	virtual CGridCell* CreateObject() const                    { return new CGridDefaultCell; }
	virtual LPCTSTR IsTypeOf() const                           { return _T("CGridDefaultCell"); }
...
public:
	...
	virtual _gctype_t   GetCType() const                       { return static_cast<_gctype_t>(GCT_ALL); }
	virtual void        SetCType(_gctype_t /*wctype*/)         { ATLASSERT(FALSE); }
	virtual void        SetCoords(int /*row*/, int /*col*/)    { ATLASSERT(FALSE); }
    virtual void        SetFont(const LOGFONT* /*plf*/);
    virtual LOGFONT*    GetFont() const;   
    virtual CFontHandle GetFontObject() const                  { return m_Font; }

protected:
    CSize m_Size;       // Default Size
    CFontHandle m_Font; // Cached font
